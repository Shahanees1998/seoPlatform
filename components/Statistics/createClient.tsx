                ...
                <div style={{ width: '45rem' }} className="px-10 py-5 bg-white shadow-lg rounded-xxl">
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-5 md:w-1/2 lg:w-1/2">
                            <div className="mb-10">
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Entreprise</label>
                    ...
                    <div className="-mx-4 w-full flex flex-wrap">
                        ...
                        <div className="w-full px-5 md:w-1/1 lg:w-1/1">
                            <div className="mb-10">
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Adresse Email  </label>
                        ...
                        <div className="w-full px-5 md:w-1/1 lg:w-1/1 flex justify-center">
                            <button style={{ backgroundColor: '#1B44C8' }} type="button" className="bg-blue px-10 py-2 rounded-xl text-white text-2xl">Ajouter</button>
                        </div>
                        <div className="w-full px-5 md:w-1/1 lg:w-1/1 flex justify-center" onClick={onClose}>
                            <img className="mt-12" src="/images/hero/Close.png" />
                        </div>
                    </div>
                </div>
        </div>

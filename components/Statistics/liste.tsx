...
<div className="w-full md:w-1/1 lg:w-1/1 mb-6">
                  <div className="w-full bg-grey px-10 py-5 rounded-xl shadow">
                    <h2 className="text-2xl font-bold mb-5 text-left border-b border-gray-200 py-5 flex justify-between items-center">Stratégie des mots-clés <a href="#"><img src="/images/hero/edit.png" /></a></h2>
                    <div className="-mx-4 flex flex-wrap">
                      <div className="w-full md:w-1/1 lg:w-1/1 px-5 mt-5">
                        ...
                        <input type="email" id="email" className="bg-gray-50 px-3 py-2 mb-3 w50 mr-3 border border-gray-200 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Réparation radiateurs" value="Réparation radiateurs" />
                          <button type="button" className="block px-6 py-2 text-center mb-3 text-white font-bold text-1xl bg-dark-blue rounded-full">Propose moi des mots-clés</button>
                      </div>
                    </div>
                    <div className="w-full md:w-1/1 lg:w-1/1 px-5 mt-5">
                        ...
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                          <thead className="text-md text-left font-semibold text-gray-700 uppercase table-head dark:bg-gray-700 dark:text-gray-400">
                            <tr className="">
                              ...
                              <th scope="col" className="px-6 py-3">
                                <button type="button" className="block px-6 py-2 text-center text-white font-bold text-1xl bg-dark-blue rounded-full">Ajoute les mots-clés</button>
                              </th>
                            </tr>
                          </thead>
                          <tbody>
                    ...
                    <tbody>
                      <tr className="bg-white border dark:bg-gray-800">
                        ...
                        <td className="px-6 py-5 flex items-center">
                          <a href="#"><img className="mr-5" src="/images/hero/link.png" /></a>

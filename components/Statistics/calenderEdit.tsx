                    ...
                    <div className="container">
                        <div className="-mx-4 flex flex-wrap items-center relative z-10">
                            <div className="w-full px-5 md:w-1/1 lg:w-1/1 mx-auto">
                                <div className="px-10 py-5  bg-white shadow-lg rounded-xl">
                                    <div className="-mx-4 popup-content flex flex-wrap">
                                        <div className="w-full px-5 md:w-1/2 lg:w-1/2">
                                            <h2 className="font-semibold text-xl text-black text-left py-5">Voici 10 proposition de titres SEO pour le mot-clé  “mot-clé”</h2>
                                        </div>
                                        <div className="w-full px-5 md:w-1/2 lg:w-1/2">
                                            <h2 className="font-semibold text-xl text-black text-left py-5 flex items-center justify-end sm-flex-none">Relancer <a href="#"><img className="px-3" src="/images/hero/repeat.png" /></a></h2>
                                        </div>
                                    ...
                                    <div className="-mx-4 flex items-center justify-end">
                                        <div className="px-5 flex justify-center">
                                            <button type="button" style={{ backgroundColor: '#1B44C8' }} className="bg-dark-blue px-10 py-2 rounded-full text-white text-1xl">valider</button>
                                        </div>
                                        <div className="px-5 flex justify-center">
                                            <button type="button" style={{ backgroundColor: '#1B44C8' }} className="bg-dark-blue px-10 py-2 rounded-full text-white text-1xl" onClick={onClose}>Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

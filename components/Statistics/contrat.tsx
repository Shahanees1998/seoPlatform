    ...
    <>
            ...
            <div className="w-full md:w-1/3 lg:w-1/3 px-5 flex justify-end items-center sm-flex-none mt-5">
              <div className="w-full bg-white rounded-xl shadow px-6 py-3 box-h-571">
                ...
                <div className="flex justify-end items-center py-5">
                  ...
                  <input type="email" id="email" className="bg-input py-3 border numberInput border-gray-200 text-black text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="45" />
                </div>
                ...
                <div className="grid gridHold">
                  <div>
                    ...
                    <div className="flex justify-center items-center  py-5">
                      ...
                      <input type="email" id="email" className="bg-input px-3 py-3 border numberInput border-gray-200 text-black text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="10" />
                    </div>
      ...
      <div className="w-full md:w-1/1 lg:w-1/1 mb-6 mt-12">
        <div className="flex justify-end">
          <a href="clients-ajout.html">
            <button type="button" style={{ backgroundColor: '#1B44C8' }}
              className="block px-10 py-2 text-center text-white font-bold text-1xl mb-10 bg-dark-blue rounded-full">Ajouter un contrat</button>
          </a>
        </div>
